...
class SAlert extends React.Component {
    ...
    render() {
        ...
        const sAlertElemsTopRight = this.state.dataRight.filter(data => !data.position || data.position === 'top-right').map(mapFunc);
        const sAlertElemsBottomRight = this.state.dataRight.filter(data => data.position === 'bottom-left').map(mapFunc);
        const sAlertElemsTopLeft = this.state.dataLeft.filter(data => data.position === 'top-left').map(mapFunc);
        const sAlertElemsBottomLeft = this.state.dataLeft.filter(data => data.position === 'bottom-left').map(mapFunc);
        ...
        return (
            <div className="s-alert-wrapper">
                <div className="s-alert-position-wrapper s-alert-top-right-wrapper">{sAlertElemsTopRight}</div>
                <div className="s-alert-position-wrapper s-alert-bottom-right-wrapper">{sAlertElemsBottomRight}</div>
                <div className="s-alert-position-wrapper s-alert-top-left-wrapper">{sAlertElemsTopLeft}</div>
                <div className="s-alert-position-wrapper s-alert-bottom-left-wrapper">{sAlertElemsBottomLeft}</div>
                <div className="s-alert-position-wrapper s-alert-top-wrapper">{sAlertElemsTop}</div>
                <div className="s-alert-position-wrapper s-alert-bottom-wrapper">{sAlertElemsBottom}</div>
            </div>
        );
    }
}
