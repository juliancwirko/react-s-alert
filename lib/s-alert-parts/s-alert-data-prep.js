...
const getAlertData = function (sAlertPosition) {
    ...
    } else if (sAlertPosition === 'full-top') {
        query = item => item.position === 'top' || item.position === 'top-center' || (!item.position && sAlertGlobalConfig.position === 'top');
    } else if (sAlertPosition === 'full-bottom') {
        query = item => item.position === 'bottom' || item.position === 'bottom-center' || (!item.position && sAlertGlobalConfig.position === 'bottom');
    }
    ...
    return sAlertCollection.map(alert => {
        ...
        if (aStack) {
            ...
            let reactComponent = ReactDOM.render(reactElement, docElement);
